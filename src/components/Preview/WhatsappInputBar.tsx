        ...
        <div className="flex-1 rounded-full bg-white border border-black/5 px-2 py-2 text-[12px] text-slate-400 flex justify-center items-center">
          <div className="h-full w-auto mr-2.5">
            <span aria-hidden="true" data-icon="plus-rounded" className="">
              <svg viewBox="0 0 24 24" height="16" width="16" preserveAspectRatio="xMidYMid meet" className="text-black" fill="none">
          ...
          <div>
            <span aria-hidden="true" data-icon="mic-outlined" className="h-full w-auto">
              <svg viewBox="0 0 24 24" height="18" width="18" preserveAspectRatio="xMidYMid meet" className="text-black">
